...
import com.example.cryptocurrency_app_jetpack.domain.use_case.get_coins.GetCoinsUseCase
    ...
    private fun getCoins() {
        getCoinsUseCase().onEach { result ->
            when (result) {
                ...
                is Resource.Error -> {
                    _state.value = CoinListState(error = result.message ?: "Es ist ein unerwarteter Fehler aufgetreten")
                }
